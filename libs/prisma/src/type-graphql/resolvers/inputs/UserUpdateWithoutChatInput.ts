...
@TypeGraphQL.InputType("UserUpdateWithoutChatInput", {
  isAbstract: true
})
export class UserUpdateWithoutChatInput {
  ...
  @TypeGraphQL.Field(_type => ProjectsOnUsersUpdateManyWithoutUserNestedInput, {
    nullable: true
  })
